        ...
        <CardsContainer>
          <BigCardContainer style={{ width: "55%" }}>
            <BigCard
              ...
              amount={currencyFormatter(
                viewPocketBalance?.data?.targetPocket ?? 0
              )}
          ...
          >
            ...
            <SmallCard
              ...
              amount={currencyFormatter(
                viewPocketBalance?.data?.lockPocket ?? 0
              )}
              content={
                "Keep money aside out of arms reach for as long as you desire, and earn up to 5% interest."
              }
        ...
        <TransactionContainer>
          ...
          {targetPocketHistory?.data?.map((element, index) => {
            return (
              <Credit
                onClick={() =>
                  !element?.pocket_status &&
                  history.push(`/pocket_plans/target_withdraw/${element._id}`)
                }
                key={index}
                className={index === 0 ? "custom-active" : null}
                style={{
                  width: "65%",
                  cursor: "pointer",
                  alignItems: "center",
          ...
          {!targetPocketHistory?.data?.length && (
